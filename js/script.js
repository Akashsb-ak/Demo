...
(function ($) {
    ...
    if ($(".project-carousel").length) {
        $(".project-carousel").owlCarousel({
            ...
            autoplayTimeout: 10000,
            navText: ['<span class="fa fa-long-arrow-left"></span>', '<span class="fa fa-long-arrow-right"></span>'],
            responsive: { 0: { items: 1 }, 600: { items: 2, margin: 15 }, 1024: { items: 3 }, 1200: { items: 4 } },
        });
    }
    if ($(".project-carousel-two").length) {
        $(".project-carousel-two").owlCarousel({
            ...
            autoplayTimeout: 10000,
            navText: ['<span class="fa fa-long-arrow-left"></span>', '<span class="fa fa-long-arrow-right"></span>'],
            responsive: { 0: { items: 1 }, 768: { items: 2 }, 991: { items: 2 }, 1200: { items: 3 } },
        });
    }
    ...
    if ($(".services-carousel-two").length) {
        var swiper = new Swiper(".services-carousel-two", {
            ...
            spaceBetween: 8,
            freeMode: true,
            breakpoints: { 320: { slidesPerView: 2 }, 425: { slidesPerView: 3 }, 600: { slidesPerView: 4 }, 768: { slidesPerView: 5 } },
        });
    }
    ...
    if ($(".testimonial-content").length) {
        var testimonial_thumbs = new Swiper(".testimonial-thumbs", { spaceBetween: 0, direction: "vertical", loop: false, slidesPerView: 3, breakpoints: { 320: { slidesPerView: 3 }, 600: { slidesPerView: 3 } } });
        var testimonial_content = new Swiper(".testimonial-content", { spaceBetween: 0, effect: "fade", loop: true, thumbs: { swiper: testimonial_thumbs }, pagination: { el: ".testimonial-pagination", clickable: true } });
    }
